...
// a linked list.
func (s QStack) MarshalJSON() ([]byte, error) {
	return json.Marshal(s.Items())
}

// JSONL implements rwxrob/json.AsJSON.
func (s *QStack) JSON() ([]byte, error) { return s.MarshalJSON() }

// JSONL implements rwxrob/json.AsJSON.
func (s *QStack) JSONL() ([]byte, error) {
	return json.MarshalIndent(s, "  ", "  ")
}

// String implements rwxrob/json.Stringer and fmt.Stringer.
func (s QStack) String() string {
	byt, err := s.JSON()
	if err != nil {
		log.Print(err)
	}
...
func (s QStack) StringLong() string {
	byt, err := s.JSONL()
	if err != nil {
		log.Print(err)
	}
...
func (s *QStack) Print() { fmt.Println(s.String()) }

// PrintLong implements rwxrob/json.Printer.
func (s *QStack) PrintLong() { fmt.Println(s.StringLong()) }

// Log implements rwxrob/json.Logger.
func (s QStack) Log() { log.Print(s.String()) }

// LogLong implements rwxrob/json.Logger.
func (s QStack) LogLong() { log.Print(s.StringLong()) }
